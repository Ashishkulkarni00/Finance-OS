...
public class CommitmentController {
    ...
    public CommitmentController(CommitmentService service, CommitmentMapper mapper) {
    ...
    public ResponseEntity<CommitmentResponse> create(@Valid @RequestBody CreateCommitmentRequest request) {
        CommitmentView created = service.create(request);
    ...
    public CommitmentResponse createFromLoan(@PathVariable Long loanId) {
        return mapper.toResponse(service.createFromLoan(loanId));
    }
    ...
    public CommitmentResponse createFromInvestment(@PathVariable Long investmentId) {
        return mapper.toResponse(service.createFromInvestment(investmentId));
    }
